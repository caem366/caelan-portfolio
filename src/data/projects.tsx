...
export const projects: Project[] = [
  {
    ...
    highlights: [
      "Designed a mobile prototype around task planning, focus sessions, progress, and self-care moments.",
      "Used research synthesis, personas, Crazy 8s, wireframes, and prototyping to narrow a broad student-support concept into an integrated productivity and wellbeing experience.",
    ],
